...
public class RestClientProductsRestClient implements ProductsRestClient {
    ...
    private static final ParameterizedTypeReference<List<Product>> PRODUCTS_TYPE_REFERENCE = new ParameterizedTypeReference<List<Product>>(){};
    ...
    public Product createProduct(String title, String details) {
        try{
            return this.restClient.post().uri("/api/v1/catalogue/products")
    ...
    public Optional<Product> findById(int productId) {
        try {
            return Optional.ofNullable(this.restClient.get().uri("/api/v1/catalogue/products/{productId}", productId)
    ...
    public void updateProduct(int productId, String title, String details) {
        try{
            this.restClient.patch().uri("/api/v1/catalogue/products/{productId}", productId)
                .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteProduct(int productId) {
        try {
            this.restClient.delete().uri("/api/v1/catalogue/products/{productId}", productId)
